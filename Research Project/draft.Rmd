...
Research Proposal
RESEARCH QUESTION
This study seeks to answer the question: What effect does the addition of new bike lanes have on the number of bike users, car users, and pedestrian accidents in an urban area? 
HYPOTHESIS
The hypothesis is that the addition of new bike lanes will lead to an increase in bike users, a decrease in car users, and a reduction in pedestrian accidents. Furthermore, these changes are expected to contribute to reduced congestion, which could provide economic benefits similar to those outlined by Hartgen & Fields (2009), who found that reducing congestion enhances regional productivity.
IMPORTANCE AND SIGNIFICANCE
As urbanization continues to rise, cities are grappling with increased traffic congestion and its negative consequences on economic productivity, environmental sustainability, and public safety. Hartgen and Fields (2009) found that reducing congestion by improving travel speeds could increase regional productivity by up to 1%, translating to billions of dollars in economic benefits for cities. Research by Prud’homme and Lee (1999) also highlights that cities with commute times of less than 30 minutes tend to experience significant productivity gains. Therefore, the importance of this research lies in its potential to inform city planners and policymakers on whether bike lanes can serve as a viable tool for reducing traffic congestion and enhancing urban economic growth.
This research will also assess the practical benefits of bike lanes beyond financial considerations. A well-designed bike lane network can decrease pedestrian accidents by streamlining traffic flows and reducing interactions between cars and pedestrians. Moreover, a reduction in car use can lower congestion, reduce travel times for all road users, and minimize harmful carbon emissions. By promoting cycling over driving, cities may improve not only environmental sustainability but also economic vitality by reducing gridlock, as shown in the Hartgen & Fields study.
Ultimately, this study will help cities balance the immediate costs of bike lane construction, including the financial and other implications of removing car lanes and parking spots, with the long-term benefits of improved safety, reduced commute times, and enhanced economic productivity.
PRIOR RESEARCH
Previous studies examining the impact of bike lanes on urban transportation have produced mixed results. Some research suggests that bike lanes lead to increased cycling and reduced car usage, while other studies indicate that the impact is minimal. For instance, Hwang et al. (2023) used simulated data and found a significant increase in non-motorized transportation methods, including other methods such as public transit and walking, but did not observe a specific increase in biking. Similarly, Buck et al. (2011) found a significant correlation between bike lanes and the proximity of bike share stations.
Hartgen and Fields (2009) found that reducing traffic congestion can lead to a 1% increase in regional productivity if travel speeds improve by just 10%. This provides an economic rationale for infrastructure investments that reduce congestion, including bike lanes, as they may contribute to free-flowing traffic and improve access to employment and commercial centers. Additionally, Prud’homme and Lee (1999) demonstrated that reducing commute times to less than 30 minutes can significantly boost economic productivity. By improving commuting efficiency, particularly for those traveling by bike, bike lanes could play a crucial role in optimizing urban productivity. This study will assess whether bike lanes can help cities achieve these economic benefits by alleviating gridlock and improving commute times.
Importantly, there is a notable lack of comprehensive research on how bike lanes affect pedestrian accidents. This study aims to fill this gap by providing a holistic view of the impact of bike lanes on urban transportation dynamics, considering not only bike and car usage but also pedestrian safety and overall traffic patterns.
Furthermore, many previous studies have focused on a single city, making it challenging to determine whether observed relationships are inherent to the variables being studied or are influenced by the specific environment. By expanding the research to multiple cities, this study aims to achieve more reliable and generalizable results. This multi-city approach will help to identify consistent patterns and provide a broader understanding of the impact of bike lanes.
A further limitation of prior studies was often focusing on the growth in bike ridership instead of the decrease, or smaller increase, in car ridership. While predicting the total increase in bike ridership is useful for many instances, understanding the specific number of bike riders who otherwise would have been car users is also crucial. This study will address this aspect, providing valuable insights into how bike lanes can effectively reduce car usage and contribute to sustainable urban transportation.
METHODOLOGY
Data Collection
To analyze the impact of bike lanes, data will be collected from various sources across at least three of the following cities: New York City, San Francisco, Portland, Washington DC, and Chicago. The decision on which cities to use will hinge on the reliability of the data being sourced from each of them.
Data for these cities will be sourced from a variety of open-source materials. The bike share networks in these cities, all operated by Lyft, contain valuable bike usage data. Bike lane and vehicle traffic count data can be found on these cities’ respective open data platforms. Pedestrian accident information can be sourced from Vision Zero in the respective city. 
Variables
The primary variables being analyzed will be total footage of bike lanes, bike usage count, motor vehicle usage count, and pedestrian accident count. Additionally, weather and population density data will be incorporated into the analysis to control for those factors. 
Data Analysis
Several potential analytical approaches are being considered, depending on data availability and the dataset’s structure. Generalized Linear Models (GLMs) like Poisson or Negative Binomial regression will be explored for count-based dependent variables such as bike users, car users, and pedestrian accidents. These models can incorporate multiple control variables, such as population density and weather conditions. Panel Data Regression will also be considered, as the dataset spans multiple cities and years. This method can account for both within-city changes over time and differences between cities, helping to isolate the effect of new bike lanes from other city-specific or time-specific factors.
For cities with granular, time-based data, Time Series Analysis will be explored to analyze trends over time and detect shifts in the number of bike users, car users, and pedestrian accidents following the introduction of new bike lanes. Additionally, a Difference-in-Differences (DiD) approach will be used if a suitable control group can be identified. This method compares changes in outcomes between areas with new bike lanes and those without, before and after the intervention, helping to establish a causal relationship.
These methods are preliminary considerations and will be refined as the research progresses. Depending on the quality of the data and the availability of comparable control groups, certain models may prove more suitable than others. The final selection of statistical and machine learning methods will be based on what best captures the effects of bike lanes on urban transportation patterns while accounting for potential confounding variables.
EXPECTED OUTCOMES
The addition of bike lanes is expected to yield several positive outcomes. First, an increase in bike users is anticipated as safer, dedicated lanes encourage more people to choose cycling over driving. This shift should correspond with a decrease in car users, reducing traffic congestion and contributing to lower emissions. Additionally, the introduction of bike lanes is predicted to result in fewer pedestrian accidents, as more organized street designs separate different types of traffic, leading to improved overall safety.
Quantifying these changes will provide urban planners and policymakers with actionable data, enabling them to make informed decisions about future transportation infrastructure. Beyond encouraging sustainable transportation, the insights gained could help cities create safer, more efficient transit environments, while also addressing broader environmental goals. Ultimately, these findings will support the development of cities that prioritize both public safety and ecological sustainability.
...
# Recreate the bike_to_traffic_ratio with the decomposed values
selected_data_nyc$bike_to_traffic_ratio_decomposed <- decomposed_bike_count$time.series[, "seasonal"] / decomposed_mv_traffic$time.series[, "seasonal"]
...
```{r}
# Plot the decomposed bike_to_traffic_ratio over time
ggplot(selected_data_nyc, aes(x = date, y = bike_to_traffic_ratio)) +
  geom_line() +
  labs(title = "Decomposed Bike to Traffic Ratio Over Time", x = "Date", y = "Bike to Traffic Ratio (Decomposed)") +
  theme_minimal()
``` 
...
```{r}
# Redo with the original monthly data
