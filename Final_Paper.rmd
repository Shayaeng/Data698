...
nyc_scaled_evaluation_metrics <- nyc_scaled_evaluation_metrics[, c(1, 3, 2, 4, 5)]

nyc_scaled_evaluation_metrics <- nyc_scaled_evaluation_metrics |>
  mutate(Model = c("Decision Tree", "Random Forest", "XGBoost")) |>
  select(Model, everything())
```
...
corrplot(correlation_matrix_ny, method = "color", type = "upper", tl.col = "black", tl.srt = 45)
```
...
# Create a correlation heatmap
corrplot(correlation_matrix_sf, method = "color", type = "upper", tl.col = "black", tl.srt = 45)
```
